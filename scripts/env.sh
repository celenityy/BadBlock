...
function setup_path() {
  ...
  "${BADBLOCK_LN}" -sf "${BADBLOCK_XZ}" "${BADBLOCK_PATH}/xz"
...
function setup_lint_path() {
  "${BADBLOCK_RM}" -rf "${BADBLOCK_LINT_PATH}"
  "${BADBLOCK_MKDIR}" -p "${BADBLOCK_LINT_PATH}"

  "${BADBLOCK_LN}" -sf "${BADBLOCK_GIT}" "${BADBLOCK_LINT_PATH}/git"
  "${BADBLOCK_LN}" -sf "${BADBLOCK_SHELLCHECK}" "${BADBLOCK_LINT_PATH}/shellcheck"
  "${BADBLOCK_LN}" -sf "${BADBLOCK_SHFMT}" "${BADBLOCK_LINT_PATH}/shfmt"

  readonly PATH="${BADBLOCK_LINT_PATH}"
  export PATH
}
